...
const MODEL_OPTIONS = [
  { value: 'gemini-2.0-flash-preview-image-generation', label: 'Nano Banana' },
  { value: 'gemini-2.0-flash-exp', label: 'Nano Banana Pro' },
  { value: 'gemini-2.0-pro-exp', label: 'Nano Banana 2' }
]
